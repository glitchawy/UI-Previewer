...
const metroPort = Number(process.env.EXPO_BUILD_METRO_PORT ?? 18081);

if (!Number.isSafeInteger(metroPort) || metroPort <= 0 || metroPort > 65535) {
  throw new Error('EXPO_BUILD_METRO_PORT must be a valid TCP port');
}
