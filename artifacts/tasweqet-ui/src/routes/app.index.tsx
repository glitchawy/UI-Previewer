...
export const Route = createFileRoute("/app/")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "طلبات بيتك | الرئيسية" },
      { property: "og:description", content: "اطلب أكلك المفضل من أقرب المطاعم إليك" },
      ...
      <header className="sticky top-0 z-20 flex items-center gap-sm border-b border-outline-variant bg-surface-container-lowest/95 px-md py-3 backdrop-blur">
        <Link to="/app/address" className="flex min-w-0 flex-1 items-center gap-2">
          ...
          <span className="min-w-0 flex-1 text-right">
            ...
            <span className="block truncate font-label-lg text-label-lg text-on-surface">٧ ش ٩، المعادي</span>
          </span>
                ...
                <Card className="overflow-hidden transition hover:border-secondary active:scale-[0.99]">
                  <div className="relative h-32 w-full">
                    ...
                    <button
                      type="button"
                      aria-label="مفضلة"
                      className="absolute left-2 top-2 flex size-8 items-center justify-center rounded-full bg-surface-container-lowest/90 text-error"
                    >
