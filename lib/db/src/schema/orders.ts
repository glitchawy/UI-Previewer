...
export const ordersTable = pgTable("orders", {
  ...
  estimatedPreparationMinutes: integer("estimated_preparation_minutes"),
  estimatedTravelMinutes: integer("estimated_travel_minutes"),
  estimatedTotalMinutes: integer("estimated_total_minutes"),
  estimatedDistanceKm: doublePrecision("estimated_distance_km"),
  estimatedDeliveryMethod: text("estimated_delivery_method"),
